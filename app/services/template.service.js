const from = '"Placement Portal" <placementportal@viit.ac.in>';
const baseUrl = 'http://placements.viit.ac.in';
const email_signature = '<br><br>With Regards.<br><br>Prof. Pradnya Mehta<br>In-charge, Training & Placement<br>VIIT Pune<br>+91-141-2529065';
    ...
    switch (mailType) {
        ...
        case 'sendOTP':
            return {
                ...
                subject: 'Login Request : Placement Cell, VIIT Pune',
                text: 'Hello '+ data.student_name + 'We have received a login request for your account.Please find the below OTP to proceed further With Regards, Prof. Pradnya Mehta',
        ...
        case 'forgotPassword':
            return {
                from: from,
                to: data.college_email,
                subject: 'Reset Password Request : Placement Cell, VIIT Pune',
                text: 'Hello '+ data.student_name + 'You requested for the reset password.Please find the below link Reset password With Regards, Prof. Pradnya Mehta',
        ...
        case 'passwordUpdated':
            return {
                from: from,
                to: data.college_email,
                subject: 'Password Updated : Placement Cell, VIIT Pune',
                text: 'Hello '+ data.student_name + 'Your password has been successfully updated.With Regards, Prof. Pradnya Mehta',
        ...
        case 'approveInterviewExperience':
            return {
                from: from,
                to: data.author_id + '@viit.ac.in',
                subject: 'Yay! We have published your article ' + data.title,
                text: 'Hello '+ data.author_name + 'Thanks for sharing your interview process and thoughts with us With Regards, Prof. Pradnya Mehta',
