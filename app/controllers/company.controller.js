    ...
    Company
        ...
        .then(async data => {
            ...
            for(let course in _b.eligibility){
                if(course == "UG"){
                    email.push(batch-4+"_ug_all@viit.ac.in");
                } else if(course == "MTech"){
                    email.push(batch-2+"_MTECH@viit.ac.in");
                } else if(course == "MPlan"){
                    email.push(batch-2+"_PAR@viit.ac.in");
                } else if(course == "MSc"){
                    email.push(batch-2+"_MSC@viit.ac.in");
                } else if(course == "MBA"){
                    email.push(batch-2+"_PBM@viit.ac.in");
                }
            }
